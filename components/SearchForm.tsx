...
const SearchForm = ({ query } : {query?: string}) => {
  ...
  return (
    <Form action={'/'} scroll={false} className="relative mb-4" id="search-form">
        ...
        <input name='query' defaultValue={query} type="text" placeholder="SEARCH STARTUP" className="font-bold text-black w-xs sm:w-lg bg-white py-4 px-5 rounded-full border-black border-5 outline-0" />
