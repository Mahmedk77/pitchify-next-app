...
const StartupCard = ({post} : {post: StartupCardType}) => {
  return (
    <div className='bg-white w-full flex flex-col gap-2 border-[5px] border-black border-r-[10px] border-b-[8px] py-6 px-5 rounded-[26px] shadow-200 hover:border-[#EE2B69] transition-all duration-500 hover:shadow-300 hover:bg-[#FFE8F0]'>
